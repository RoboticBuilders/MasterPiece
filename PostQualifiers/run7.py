...
def musicConcert():
    ...
    gyroStraightWithDriveWithAccurateDistance(distance=CM_PER_INCH*17, targetAngle=0, speed=400)
    ...
    gyroStraightWithDriveWithAccurateDistance(distance=CM_PER_INCH*1, targetAngle=-45, speed=400)
    ...
    gyroStraightWithDriveWithAccurateDistance(distance=CM_PER_INCH*10.5, targetAngle=0, speed=400, slowDown = False)
...
def augmentedReality():
    ...
    gyroStraightWithDriveWithAccurateDistance(distance = 33, speed = 500, targetAngle = _angle)
    _angle = -45
    turnToAngle(targetAngle=_angle,oneWheelTurn=True)

    # back up to pull Augmented Reality lever
    gyroStraightWithDriveWithAccurateDistance(distance=7, speed = 300, targetAngle=_angle)
...
def expertDrops():
    ...
    right_med_motor.run_angle(speed = -1000, rotation_angle = 1500, then = Stop.COAST, wait = False)

    gyroStraightWithDriveWithAccurateDistance(distance = 18, speed = 400, targetAngle = _angle)
