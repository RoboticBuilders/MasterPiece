...
def lightShow():
    ...
    gyroStraightWithDriveWithAccurateDistance(distance=11, speed=500, targetAngle=angle,backward=True)
    wait(100)
    ...
    left_med_motor.run_angle(speed=1000, rotation_angle=-2400, wait = True)
