...
def run4():
    ...
    gyroStraightWithDrive(distanceInCm = 49, speed = 400, targetAngle = _angle)
    turnToAngle(targetAngle=280, speed=200, oneWheelTurn=True)
    gyroStraightWithDrive(distanceInCm = 20, speed=400, targetAngle=280, slowDown=True)
    turnToAngle(targetAngle=30, speed=200, oneWheelTurn=True)
    gyroStraightWithDrive(distanceInCm = 10, speed=400, targetAngle=30, slowDown=True, backward=True)
    turnToAngle(targetAngle=270, speed=200, oneWheelTurn=True)
    gyroStraightWithDrive(distanceInCm = 20, speed=400, targetAngle=270, slowDown=True)
